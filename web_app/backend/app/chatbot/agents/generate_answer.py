...
def generate_answer_node(state: GraphState) -> dict:
    """Generate contextual response using conversation history and movie data."""
    ...
    if enriched:
        ...
        movie_context = (
            "The user is asking follow-up questions about movies "
            "previously suggested in the conversation."
        )
